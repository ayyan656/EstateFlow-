  ...
  return (
    <div className="w-full">
      ...
      <div className="relative">
        ...
        <input
          className={`w-full ${icon ? 'pl-10 pr-3' : 'px-3'} py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-accent focus:border-accent sm:text-sm bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-100 transition-colors duration-200 ${
